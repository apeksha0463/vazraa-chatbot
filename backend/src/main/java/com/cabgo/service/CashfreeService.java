...
public class CashfreeService {
    ...
    public CashfreeOrderResult createOrder(String internalOrderId,
        ...
        try {
            ...
            // After payment, redirect user back to WhatsApp chat with "Payment Done"
            linkMeta.put("return_url", "https://api.whatsapp.com/send?phone=" + whatsappNumber + "&text=Payment%20Done");
